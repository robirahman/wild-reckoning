...
export const ENCYCLOPEDIA_ENTRIES: EncyclopediaEntry[] = [
  ...
  },
  {
    ...
    content: 'Species fall on a spectrum between r-strategists (many offspring, little parental investment, such as salmon, sea turtles, and fig wasps) and K-strategists (few offspring, high investment, such as elephants, wolves, and humans). R-strategists bet on numbers: produce thousands of eggs and a few will survive. K-strategists bet on quality: invest heavily in each offspring to maximize its survival. Most species fall somewhere between these extremes.',
    unlockCondition: { type: 'default' },
  },
  {
