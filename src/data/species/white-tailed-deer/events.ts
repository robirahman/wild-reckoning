    ...
    choices: [
      {
        ...
        narrativeResult: 'You lower your head and rush the nearest coyote, lashing out with your front hooves. The coyote yelps and both retreat — for now.',
      ...
      },
      {
        ...
        narrativeResult: 'You freeze, barely breathing. The coyotes circle closer, sniffing, but the fawns lie motionless in the tall grass. Eventually the coyotes move on to easier hunting grounds.',
    ...
    choices: [
      {
        ...
        narrativeResult: 'You trot away without looking back, crossing the creek that marked the boundary of everything you knew. Ahead lies unfamiliar forest, unfamiliar dangers, and the possibility of a range of your own.',
      ...
      },
      {
        ...
        narrativeResult: 'You stand your ground, but the buck charges again. His antlers score your flank and you are driven from the meadow. The result is the same — you leave, but bloodied.',
    ...
    choices: [
      {
        ...
        narrativeResult: 'You burst from the tree line and bound across the road. Tires screech. You clear the far ditch and crash into the brush on the other side, legs trembling.',
      ...
      },
      {
        ...
        narrativeResult: 'You walk the tree line for an hour until you find a culvert under the road. It reeks of stagnant water, but you squeeze through. Safer, but the detour burned energy.',
    ...
    choices: [
      {
        ...
        narrativeResult: 'You rub your antlers on saplings and begin creating bedding sites. Over the next weeks, this unfamiliar forest starts to feel like home. You learn where the acorns fall and where the predators travel.',
      ...
      },
      {
        ...
        narrativeResult: 'You pass through and continue searching. Better habitat may lie ahead — or it may not.',
