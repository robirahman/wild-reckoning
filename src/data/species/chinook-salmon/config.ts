...
export const CHINOOK_SALMON_CONFIG: SpeciesConfig = {
  ...
  diseaseDeathChanceAtCritical: 0.025,  // Reduced: wild salmon more resistant than farmed
  naturalHealingRate: 8,  // Weekly turns; must outpace sea lice drain + event damage
  attentionBudget: 14,
  ...
  reproduction: {
    type: 'semelparous',
    spawningMinAge: 42,  // Real chinook spawn at 3-7 years; min 3.5yr
    spawningSeasons: ['autumn'],  // Peak spawning is late summer/autumn
    baseEggCount: 4000,
