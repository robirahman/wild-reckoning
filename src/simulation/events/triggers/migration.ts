...
export const winterYardScoutTrigger: SimulationTrigger = {
...
export const travelHazardsTrigger: SimulationTrigger = {
...
export const springReturnTrigger: SimulationTrigger = {
