...
export const ROAD_CROSSINGS: RoadCrossingFragment[] = [
  { timeOfDay: 'night', text: 'The road appears suddenly, a flat, pale strip cutting through the forest. Headlights sweep through the trees at irregular intervals, each pair a fast-moving predator with no scent and no sound until it is upon you.' },
...
export const WINTER_YARD_ARRIVAL: string[] = [
  'The hemlock valley opens before you, dark and sheltered, the old hemlocks forming a living windbreak. The packed snow is marked by dozens of hoofprints. Other deer have already arrived.',
  ...
  'The sky is clear and the sun almost warm as you descend into the wintering grounds. Steam rises from the backs of deer already bedded in the shelter of the hemlocks. The scent of the herd is thick and warm.',
...
export const SPRING_DEPARTURES: DepartureFragment[] = [
  ...
  { condition: 'critical', text: 'You are barely alive. The winter yard\'s browse ran out weeks ago. The walk north may be the last thing you do, but staying is worse.' },
];
...
export const TRAVEL_HAZARD_NARRATIVES: ContextualFragment[] = [
  ...
  {
    terrain: 'mountain',
    text: 'A rockslide has obliterated the trail ahead, a heap of raw granite and uprooted saplings blocking the pass. You pick your way across the debris field, each stone wobbling underfoot, the slope below you steep enough to kill.',
  },
  {
    terrain: 'river',
  ...
  {
    weather: 'storm',
    text: 'Thunder cracks overhead and the sky opens. Rain comes in sheets so heavy you cannot see the trail. The ground turns to mud beneath your hooves, each step a negotiation with gravity. A flash of lightning reveals the forest edge. Still far.',
  },
  {
    text: 'The trail narrows to a ledge above a steep ravine. The drop is sheer, the footing crumbling, and the wind pushes at your ribs with steady force. You press your shoulder against the rock face and move one careful hoof at a time, not breathing until the path widens again.',
  },
];
