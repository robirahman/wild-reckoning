...
export const CANID_DETECTIONS: DetectionOpening[] = [
  ...
  { sense: 'smell', season: 'winter', text: 'The winter air is so clean that the wolf-musk hits you hard. Rank, predatory, impossibly close. The cold has preserved every molecule of their scent trail.' },
  // Spring variants
...
export const FELID_DETECTIONS: DetectionOpening[] = [
  { sense: 'sound', text: 'The birds have stopped singing. A prickling sensation crawls up the back of your neck, the certainty of being watched by something that does not blink.' },
  ...
  { sense: 'sight', terrain: 'forest', text: 'A thick branch overhead dips under a weight that is not wind. You catch a glimpse of a long, heavy tail hanging motionless among the pine boughs. The heavy tail of a cat waiting to drop.' },
];
...
export const CANID_PURSUITS: PursuitFragment[] = [
  ...
  { locomotionThreshold: 70, escaped: true, text: 'Your legs answer the call of panic. You run without thought, leaping deadfall, crashing through brush, and the distance opens between you and the gray shapes. They fall back, one by one, conserving energy. They will try again later. Not now.' },
  ...
  { locomotionThreshold: 0, escaped: false, terrain: 'open', text: 'Open ground. No cover, no obstacles, nowhere to turn. The wolves fan out wide behind you, running the long relay they were born for. Your sprint burns bright and brief, but their endurance does not flag. The gap closes.' },
  // Forest — obstacle advantage for deer
  { locomotionThreshold: 50, escaped: true, terrain: 'forest', text: 'You plunge into the dense timber and the forest becomes your ally. You thread between trunks that force the pack to break formation, leap deadfall that tangles their wider bodies. The pursuit dissolves into frustrated barking somewhere behind you as you weave deeper into the thick timber.' },
];
...
export const FELID_PURSUITS: PursuitFragment[] = [
  ...
  { locomotionThreshold: 40, escaped: true, text: 'You stumble sideways at the last instant and the tawny shape hurtles past, hitting the ground where you stood. For one frozen moment you see its face, wide and flat, and then your legs are carrying you away. It does not pursue.' },
...
export const PREDATOR_RESOLUTIONS: ResolutionFragment[] = [
  ...
  { outcome: 'escaped', terrain: 'forest', text: 'You vanish into old-growth timber so dense that pursuit is impossible. The massive trunks block every sightline. You stand motionless among them, sides heaving, listening to the frustrated sounds of predators circling the perimeter of a tangle they cannot enter.' },
];
...
export const WOLF_ENCOUNTER_NARRATIVES: ContextualFragment[] = [
  ...
  {
    season: 'winter',
    text: 'The pack finds you at the edge of the cedar yard where the snow is trampled to brown slush by a hundred desperate hooves. You smell them first, rank, wild, close, and then the gray shapes appear at the tree line, fanning out with the deliberate spacing of a pack that has done this before. In winter, there is nowhere to hide and the snow is a traitor beneath your feet.',
  },
  {
    season: 'winter',
    timeOfDay: 'night',
  ...
  {
    timeOfDay: 'dusk',
    text: 'The last light drains from the sky and you smell the wolves before you see them, their musk thick in the cooling air. A howl rises from somewhere behind the ridge. Then another answers from a different direction. They are closing in.',
  },
  {
    timeOfDay: 'night',
  ...
  {
    terrain: 'open',
    text: 'They appear on the far side of the meadow, seven gray shapes strung out in a loose crescent. There is no ambush here, no subtlety. Just the open ground and the only calculation: can you outrun them before the crescent closes? Your legs answer before your mind decides, and the race begins across the open grass.',
  },
  // Forest
  {
    terrain: 'forest',
  ...
  // Generic / fallback
  {
    text: 'The pack announces itself with a single, sustained howl that lifts the hair along your entire spine. Before the sound fades, you see them. Gray and silent, emerging from the tree line as though they had always been there. Your body floods with adrenaline, every muscle locking at once.',
  },
  {
    text: 'You spot the lead wolf standing motionless on the rise, watching you with an intelligence that is not hunger but something still and focused. It watches you without moving. Behind it, the rest of the pack waits, motionless, ears forward.',
  },
];
...
export const COUGAR_ENCOUNTER_NARRATIVES: ContextualFragment[] = [
  ...
  {
    terrain: 'mountain',
    text: 'The mountain trail narrows between boulders, and the feeling hits you like a physical blow. That crawling certainty of being watched from above. You scan the granite ledges and see nothing. That is the worst part. The cougar is there, somewhere in the vertical world of rock and shadow, and it has been watching you for longer than you want to know.',
  },
  {
    terrain: 'mountain',
    timeOfDay: 'dusk',
  ...
  {
    timeOfDay: 'dawn',
    text: 'The first gray light is still seeping through the trees when the shape detaches itself from the base of a fallen pine. It has been lying there all night, patient as stone, waiting for the moment you step into the kill zone. The gray half-light hides it until it moves.',
  },
  {
    timeOfDay: 'dusk',
    text: 'Twilight erases depth and distance. One moment the trail ahead is empty; the next, a massive shape is airborne, launched from a stump you mistook for shadow. The last light catches its eyes, flat and gold, before the world becomes claws and weight.',
  },
  // Generic
  {
    text: 'The forest has gone still. No birdsong, no insect hum, nothing. Every nerve in your body tightens before your eyes find the long, low shape crouched in the underbrush.',
  },
  {
    text: 'You never hear the cougar. You feel it. A displacement of air, a shadow that moves against the wind. Your body hurls itself sideways. Claws pass through the space your neck occupied a half-second ago. The cat lands, pivots, and stares.',
  },
];
...
export const HUNTER_ENCOUNTER_NARRATIVES: ContextualFragment[] = [
  ...
  {
    season: 'autumn',
    text: 'The arrow makes almost no sound, a brief fibrous whisper, and buries itself in the trunk beside you with a solid thunk. No thunder this time. You see the human perched in the tree stand barely twenty yards away, already nocking another shaft.',
  },
  ...
  // Generic
  {
    text: 'The two-legged shape appears on the ridge, silhouetted against the sky, and every deer for a hundred yards freezes in place. It carries something long and angular. You lower your profile, ease backward step by careful step, and hold still.',
  },
];
